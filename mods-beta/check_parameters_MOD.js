module.exports = {
		...
		section: 'Zaaktualizuj',
	   meta: {
		  version: '2.0.11',
		  preciseCheck: false,
		  author: 'Gotowka',
		  authorUrl: 'https://github.com/Gotowka/dbmmody/tree/main/mods-beta/check_parameters_MOD.js',
		  downloadURL: 'https://github.com/Gotowka/dbmmody/tree/main/mods-beta/check_parameters_MOD.js',
		},
	  
	  
		subtitle(data, presets) {
		  return `❌ Kliknij w żółty wykrzyknik! ❌`;
		},
...
html: function(isEvent, data) {
	return `
	<div><p>This action has been modified by Gotowka</p></div><br>
<div>
